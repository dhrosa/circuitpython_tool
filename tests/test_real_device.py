...
from circuitpython_tool import real_device
from circuitpython_tool.real_device import RealDevice, all_devices
...
def test_partition_only_and_serial_only_devices(udev: FakeUdev) -> None:
    ...
    # TODO(dhrosa): This assertion is unnecessarily ordered.
    assert all_devices() == [
        RealDevice(
